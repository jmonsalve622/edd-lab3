# Generacion de graficos a partir de resultados.csv (producido por
# ejecutar_experimentos.sh). Crea 4 imagenes PNG a 300 dpi:
#
#   - grafico_tiempos_id.png    : tiempo vs N con clave user_id
#   - grafico_tiempos_name.png  : tiempo vs N con clave user_screen_name
#   - grafico_memoria_id.png    : memoria vs N con clave user_id
#   - grafico_memoria_name.png  : memoria vs N con clave user_screen_name
#
# Cada grafico traza una linea por estructura de datos evaluada.
#
...
def graficar_datos():
    ...
    # resultados.csv no tiene encabezado, por lo que se asignan los nombres
    # de columna segun el formato que imprimen los programas en C++.
    nombres_columnas = [
    ...
    # Se separan los resultados segun el tipo de clave utilizado.
    ...
    # Una linea por estructura: tiempo promedio de insercion vs cantidad
    # de tweets procesados.
    ...
    # Memoria estimada por cada estructura (inMemorySize) vs cantidad
    # de tweets procesados.
